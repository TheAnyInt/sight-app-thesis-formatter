...
\setboolean{PicAndTabIndex}{true}%是否需要插图和列表索引,默认有图表索引(true)。
\begin{document}
...
\author{王老五}%论文作者
\major{应用电子技术教育~~2026级}%专业、年级(年级前有空格)
\enmajor{Electronic Technology Application Education 2016}%英文专业年级
\enauthor{WANG Laowu}%英文姓名
\advisor{李老师}%指导老师
\college{工程与设计学院}%学院
\serialnumber{202630184002}%学号
\code{080202}%专业代码
\submityear{二六}%提交年份二〇二〇就填二一
\submitmonth{一}%提交月份
%%!=========封面内容填写完成=============
\maketitle%%生成封面
...
\include{body/abstract}%如果中英文摘要和目录一起罗马数字编页码，请把部分移到\mainmatter前
